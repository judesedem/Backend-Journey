...
#             return False
#     return True   # only return True if no divisor was found
...
# #         if num>maxi:
# #             maxi=num
# #             new_array.append(maxi)
# #             if num<maxi and num>num:
# #                 new_array.append(num)
    
# #     for elements in new_array:
# #         if elements<maxi and elements>new_array[1]:
# #     return new_array[1]
...
# if user_input<2:
#     print("Must be atleast 2 numbers")
# else:
#     print(is_second_largest(n))
...
#         result=[]   #I need to make an array to store the results of the operations     
...
# try:   
#     while True:
#         nums=[] # another array to store the user's answers
